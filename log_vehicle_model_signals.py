...
class PlotWindow(QMainWindow):
    ...
    def update_selected_signals(self):
        ...
        self.data_buffers = {name: deque(maxlen=300) for name in self.selected_signals}
...
class VehicleSignalLogger(Node):
    def __init__(self, plot_window: PlotWindow):
        ...
        self.csv_filepath = os.path.join(logs_dir, f"vehicle_signals_{timestamp}.csv")
...
def main():
    ...
    rclpy.init()
    node = VehicleSignalLogger(plot_window)
